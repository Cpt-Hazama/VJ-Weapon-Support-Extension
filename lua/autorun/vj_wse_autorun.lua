...
if VJExists == true then
    ...
    if !WSE.REGISTERED_CW2AOTW && file_Exists("autorun/doi_atow_hl2ammo_init.lua","LUA") then
        ...
        VJ.AddNPCWeapon("VJ_Binoculars-German","doi_atow_binocularsde",vCat)
        ...
        VJ.AddNPCWeapon("VJ_Knuckledusters","doi_atow_brassknuckles",vCat)
        ...
        VJ.AddNPCWeapon("VJ_Binoculars-British","doi_atow_binocularscw",vCat)
        VJ.AddNPCWeapon("VJ_Bayonet-Lee-Enfield","doi_atow_bayonetcw",vCat)
        VJ.AddNPCWeapon("VJ_Hi-Power","doi_atow_browninghp",vCat)
        VJ.AddNPCWeapon("VJ_Model29","doi_atow_sw29",vCat)
        VJ.AddNPCWeapon("VJ_Spade-German","doi_atow_etoolde",vCat)
        ...
        VJ.AddNPCWeapon("VJ_Bayonet-Kar98k","doi_atow_bayonetde",vCat)
        ...
        VJ.AddNPCWeapon("VJ_Spade-US","doi_atow_etoolus",vCat)
        VJ.AddNPCWeapon("VJ_KABAR","doi_atow_knifeus",vCat)
        VJ.AddNPCWeapon("VJ_LewisLMG","doi_atow_lewis",vCat)
        VJ.AddNPCWeapon("VJ_Binoculars-US","doi_atow_binocularsus",vCat)
        VJ.AddNPCWeapon("VJ_M1928A1","doi_atow_m1928a1",vCat)
        VJ.AddNPCWeapon("VJ_Bayonet-M1Garand","doi_atow_bayonetus",vCat)
        VJ.AddNPCWeapon("VJ_M1903A3","doi_atow_m1903a3",vCat)
        VJ.AddNPCWeapon("VJ_Spadepickaxe-British","doi_atow_etoolcw",vCat)
